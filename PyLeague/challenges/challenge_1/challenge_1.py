...
class FrameCountChallenge(BaseChallenge):
    TESTS = [
        BaseTest("abc_def[10-100].jpg", 90),
        BaseTest("abc_def[10-100]", 90),
        BaseTest("[10-100]abc_def", 90),
        BaseTest("[-]abc_def", 0),
        BaseTest("abc_def", 0),
        BaseTest("[10-100]abc_def[20-200]", 180),
        BaseTest("[10-100]abc[3-4]_def[20-200]", 180),
